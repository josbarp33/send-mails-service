interface NotificationPosponedVariables {
...
export const fillTemplate = (variables: NotificationPosponedVariables = {}) => {
  return `
        <!DOCTYPE html>
            <html lang="en">
            <head>
            ...
            <article style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: 0 4px 16px rgba(0,0,0,0.07); overflow: hidden; border: 1px solid #e3e3e3;">
              ...
              <section style="padding: 24px 26px 10px 26px; color: #333; font-size: 17px; text-align: left;">
                ...
                <p>Te escribimos para informarte sobre tu solicitud de asesoría para el servicio <strong>${variables.serviceName || 'N/A'}</strong>.</p>
                ...
                <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 20px; margin: 20px 0; border-radius: 0 8px 8px 0;">
                  ...
                  <p style="margin: 8px 0; color: #856404;">El responsable del servicio <strong>${variables.teamName || 'N/A'}</strong> se pondrá en contacto contigo lo más pronto posible.</p>
                </div>
                ...
                <div style="background-color: #f8f9fa; border-left: 4px solid #ffd700; padding: 20px; margin: 20px 0; border-radius: 0 8px 8px 0;">
                  ...
                  <p style="margin: 8px 0; font-style: italic; color: #666;">"${variables.observaciones || 'Sin observaciones'}"</p>
                </div>
