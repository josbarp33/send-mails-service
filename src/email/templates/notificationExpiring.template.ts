        ...
        <!DOCTYPE html>
            ...
            <body style="margin: 0; padding: 0;">
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <p>Hola <strong>${variables.teamName}</strong>,</p>
                    ...
                    <p><strong>Servicio:</strong> ${variables.servicio}</p>
                    <p><strong>Fecha de Aplicación:</strong> ${variables.applicationDate}</p>
                    <p><strong>Descripción:</strong> ${variables.descripcion}</p>
                    <p><strong>Suscriptor:</strong> ${variables.suscriber}</p>
                    <p><strong>ID del Schedule:</strong> ${variables.scheduleId}</p>
                    </div>
